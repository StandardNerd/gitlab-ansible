...
gitlab_rails['ldap_servers'] = YAML.load <<-'EOS'
  main: # 'main' is the GitLab 'provider ID' of this LDAP server
    ...
    port: 389
    uid: 'sAMAccountName'
    bind_dn: 'CN=sa_intb_gitlab,OU=Technical / Service Accounts,OU=Users,OU=Police,OU=KWP2010,DC=dev,DC=police,DC=be,DC=ch'
    password: 'H&rW1@X9NBBma#s5j'
    ...
    base: 'DC=dev,DC=police,DC=be,DC=ch'
    user_filter: ''
    ## EE only
    group_base: ''
    admin_group: ''
...
nginx['ssl_certificate'] = "/etc/gitlab/ssl/gitlab.example.com.cer"
